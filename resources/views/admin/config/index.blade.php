        ...
        <div class="widget widget-content-area br-4">
            <div class="widget-one">
                ...
                <form action="{{ route('configuration.update', $config->id) }}" method="POST"
                    ...
                    @method('PUT')
                    @csrf
                    <div class="row" id="picMedia">
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                <label for="logo">LOGO</label>
                                <div style="background-color: #0e1726;" class="card col-lg-6 col-md-6 text-center">
                                    <div class="card-body">
                                        <img id="LogoView" src="{{ asset(Storage::url($config->logo)) }}"
                                            alt="your logo" width="100px" class="rounded">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <div style="background-color: #0e1726;" class="card col-lg-6 col-md-6 text-center">
                                    <div class="card-body">
                                        <img id="LogoView" src="{{ asset(Storage::url($config->icon)) }}"
                                            alt="your logo" width="100px" class="rounded">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <div style="background-color: #0e1726;" class="card col-lg-6 col-md-6 text-center">
                                    <div class="card-body">
                                        <img id="LogoView" src="{{ asset(Storage::url($config->background_image)) }}"
                                            alt="your logo" width="100px" class="rounded">
                                    </div>
                                </div>
                                <div class="row">
                                    <input type="file" id="IconInput" name="bg"
                                        class="form-control-file mt-4 @error('bg') is-invalid @enderror"
                                        accept="image/*">
                                    <a href="#" class="btn btn-danger mt-2" id="deleteBg">Delete</a>
                                </div>
                                @error('bg')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
...
@push('js-external')
<script>
    $('#deleteBg').on('click', function() {
            $.get('deleteBg/', function(res) {
            console.log(res)
            if(res.status == 1)
            {
                alert('Background deleted!')
                $( "#picMedia" ).load(window.location.href + " #picMedia" );
            } else {
                alert('Background failed to delete!')
            }
            });
        })
</script>
